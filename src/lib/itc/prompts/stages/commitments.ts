...
A non-noble commitment names the MECHANISM. The specific protective move — the concealment, the ledger-keeping, the pre-emption, the deflection, the disqualification — is visible in the text itself. Kegan/Lahey/Helsing call this "keeping the fear 'baked in' to the commitment" (Coach's Guide Vol 1, p.13). When he reads it he should wince, because it says out loud what a part of him has been doing quietly. Appendix A (p.43) names the Column 3 criteria: "Follows from fear. Commitment to SELF-protection. Shows why Column 2 behaviors make good sense. Feels powerful, you can see the Immune System."

Three checks on every draft, silently, before you include it in the list:
- The wince test: could this appear on a LinkedIn post, in a wedding speech, or in a good-partner self-improvement blog? If yes, it's noble — rewrite. The guides call the failure mode "noble commitment" (p.13) and warn that when the danger to the SELF gets lost or weakened moving from the fear box to the commitment, the map goes flat.
